            ...
            <div className="grid">
              <div className="flex flex-row flex-wrap justify-center gap-5">
                {technologies.map((technology) => (
                    <div className="w-20 md:w-36 h-20 md:h-28 flex items-center bg-white justify-center rounded-md hover:scale-110 transition-transform duration-300" key={technology.name}>
